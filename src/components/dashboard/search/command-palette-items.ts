...
export const COMMAND_LIST: readonly PaletteCommand[] = [
  ...
  },
  {
    ...
    section: "Main",
    icon: "analytics",
    description: "Performance and pipeline insights",
    keywords: ["charts", "reports", "metrics", "data"],
  },
  {
    id: "automation",
    label: "Automation",
    ...
    keywords: ["workflows", "automations", "triggers", "reminders", "rules", "zapier"],
  },
  {
    id: "import",
    label: "Import",
  ...
  },
  {
    ...
    section: "Main",
    icon: "export",
    description: "Export prospects to CSV, Excel, or PDF",
    keywords: ["download", "csv", "excel", "xlsx", "pdf", "data", "file"],
  },
  {
    id: "organization",
    label: "Organization",
